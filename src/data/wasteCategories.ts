...
export const wasteCategorization = {
    ...
    footwear_leather: ["old shoes", "belts", "leather scraps", "footwear", "leather bags", "leather jackets", "leather accessories" , "chappals", "sandals", "boots", "sneakers", "flipflops"],
...
export const secondaryWasteMapping = {
    ...
    batteries: "e_waste",
    structural: "construction_debris",
    finishing: "construction_debris",
    absorbents: "sanitary"
};
...
export const primaryToSecondaryMapping = {
    ...
    construction_debris: ["structural", "finishing"],
    sanitary: ["absorbents"]
};
